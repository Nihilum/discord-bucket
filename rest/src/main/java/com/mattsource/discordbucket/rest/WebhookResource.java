...
import com.mattsource.discordbucket.translation.TranslationService;
...
public class WebhookResource {
    ...
    public String access(@PathParam("id") Integer id) {
        ...
        TranslationService.INSTANCE.translate(jsonObject);
